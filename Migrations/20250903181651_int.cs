        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WebsiteUrl1 = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    WebsiteUrl2 = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    WebsiteUrl3 = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", null, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "مدير النظام", "Admin", "ADMIN" },
                    { "2", null, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "بائع/صاحب متجر", "Seller", "SELLER" },
                    { "3", null, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "مشتري/عميل", "Buyer", "BUYER" }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "AccessFailedCount", "City", "ConcurrencyStamp", "CreatedAt", "DateOfBirth", "District", "Email", "EmailConfirmed", "FirstName", "Gender", "IsActive", "IsEmailVerified", "IsPhoneVerified", "LastName", "Location", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "ProfileImage", "SecurityStamp", "StoreDescription", "StoreName", "TwoFactorEnabled", "UpdatedAt", "UserName", "UserType", "WebsiteUrl1", "WebsiteUrl2", "WebsiteUrl3" },
                values: new object[] { "admin-id-12345", 0, "بغداد", "FIXED-CONCURRENCY-STAMP-12345", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), new DateTime(1990, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "الكرادة", "admin@reversemarket.iq", true, "مدير", "ذكر", true, true, true, "النظام", null, false, null, "ADMIN@REVERSEMARKET.IQ", "+9647700227210", "AQAAAAIAAYagAAAAEJ3pAOTg7kfNrOQi3F9x8w0iLK1J5AudCF5pN7t8oEj5oMy8q4nRuGHu8C7c0X9Y+Q==", "+9647700227210", true, null, "FIXED-SECURITY-STAMP-12345", null, null, false, null, "+9647700227210", 1, null, null, null });

            migrationBuilder.InsertData(
                table: "UserRoles",
                columns: new[] { "RoleId", "UserId" },
                values: new object[] { "1", "admin-id-12345" });
